...
public class MainActivity extends FragmentActivity implements IEcoPointsListener {
    ...
    private void addEcoStores() {
    	// Add fake Eco-stores
        GeoObject ecoStore1 = new GeoObject();
        ecoStore1.setGeoPosition(41.387003, 2.171212);
        ecoStore1.setImageResource(R.drawable.pointer);
        mWorld.addBeyondarObject(ecoStore1);
        
        GeoObject ecoStore2 = new GeoObject();
        ecoStore2.setGeoPosition(41.386912, 2.171370);
        ecoStore2.setImageResource(R.drawable.pointer);
        mWorld.addBeyondarObject(ecoStore2);
        
        GeoObject ecoStore3 = new GeoObject();
        ecoStore3.setGeoPosition(41.386783, 2.170490);
        ecoStore3.setImageResource(R.drawable.pointer);
        mWorld.addBeyondarObject(ecoStore3);
    }
	...
	public void onEcoPointsUpdated(int points) {
		...
		int result = mDriveEfficiency + points;
		if (result >= 0 && result <= 100)
			mDriveEfficiency = result;
		updateEcoCard();
	}
}